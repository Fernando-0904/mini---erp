const elementos = {
    ...
    campoOrdenacaoProdutos: document.getElementById("ordenacaoProdutos"),
    campoTamanhoPaginaProdutos: document.getElementById("tamanhoPaginaProdutos"),
    botaoPaginaAnteriorProdutos: document.getElementById("botaoPaginaAnteriorProdutos"),
    botaoPaginaProximaProdutos: document.getElementById("botaoPaginaProximaProdutos"),
    paginaAtualProdutos: document.getElementById("paginaAtualProdutos"),
    ...
    pedidosAbertosPainel: document.getElementById("pedidosAbertosPainel"),
    movimentacoesRecentesPainel: document.getElementById("movimentacoesRecentesPainel"),
    painelAtualizadoEm: document.getElementById("painelAtualizadoEm"),
    tabelaAlertasPainel: document.getElementById("tabelaAlertasPainel"),
    tabelaAtividadePainel: document.getElementById("tabelaAtividadePainel"),
